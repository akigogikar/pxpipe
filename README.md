...
caching keeps working), and forwards. A 1568×728 image costs ≈1,456 vision
tokens (a 56×26 grid of 28-px patches) and holds ≈28,000 chars, so text wins
only above ~19 chars/token —
